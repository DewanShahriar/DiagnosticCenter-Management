        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="row" style="box-shadow: 0px 0px 10px 0px #3c8dbc; margin: 8px 53px 20px 55px; padding:20px 4px 20px 4px;">
                   <form action="<?php echo base_url('accounts/referrer-report') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="col-md-12">
                            <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                         ...
                         <center>
                            ...
                            <?php if($search['print']){?>
                            <a href="<?php echo base_url('accounts/referrer-list-print?start_date='.$search['start_date'].'&end_date='.$search['end_date'].'&user_id='.$search['user_id']); ?>" class="btn bg-green btn-sm" target="_blank"><i class="fa fa-print"></i> <?php echo $this->lang->line("print");?></a>
                            <?php }?>
                         </center>
                        </div>
                   </form>
