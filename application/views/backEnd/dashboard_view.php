		...
		<div class="col-xs-6">
            <div class="box box-info box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <!-- <a href="<?php echo base_url('admin/cow-vaccine/list') ?>" class="btn bg-purple btn-sm"><i class="fa fa-list"></i> <?php echo $this->lang->line('report_submit'); ?></a> -->
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body" style="overflow: scroll; overflow-x:auto; height: 300px;">
                    <table id="cowTypeList" class="table table-bordered table-striped table_th_info">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a href="<?php echo base_url('admin/test-details/view/'.$value->tests_id); ?>" style="text-decoration: none; color: #333;"><?= $value->invoice_number; ?></a> </td>
