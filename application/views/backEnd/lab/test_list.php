            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url('lab/test-details/add') ?>" class="btn bg-green btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line("test_details_add");?></a>
                    </div>
                </div>
                <div class="row" style="box-shadow: 0px 0px 10px 0px #00c0ef; margin: 8px 53px 20px 55px; padding:20px 4px 20px 4px;">
                   <form action="<?php echo base_url('lab/test-details/list') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                      <div class="col-md-12">
                        <div class="col-md-4">
                      ...
                      <div class="col-md-12">
                        <br>
                         <center>
                            ...
                            <?php if($search['print']){?>
                            <a href="<?php echo base_url('lab/tests-list-print?start_date='.$search['start_date'].'&end_date='.$search['end_date'].'&invoice_number='.$search['invoice_number']) ?>" class="btn bg-green btn-sm" target="_blank"><i class="fa fa-print"></i> <?php echo $this->lang->line("print");?></a>
                        <?php }?>
                         </center>
                      </div>
                   </form>
                    ...
                    <table id="userListTable" class="table table-bordered table-striped table_th_primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a href="<?php echo base_url('lab/test-details/view/'.$value->id); ?>" class="btn btn-sm bg-teal"><i class="fa fa-eye"></i></a>
