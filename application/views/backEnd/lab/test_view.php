            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url('lab/test-details-print/'.$test->id) ?>" target="_blank" class="btn bg-green btn-sm"><i class="fa fa-print"></i> <?php echo $this->lang->line("print");?></a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() ?>lab/report-format-update" method="post" enctype="multipart/form-data" class="form-horizontal">
...
<script type="text/javascript">
    function modal_show(test_details_id) {
        ...
        $.ajax({
        url: '<?php echo base_url() . "lab/modal_data/"; ?>'+test_details_id,
        method: 'post',
   ...
   $(document).ready(function(){  
        $('#payment_submit_form').on('submit', function(e){ 
            ...
            if(paid_amount == '') { 
                ...
                $.post("<?php echo base_url() . "lab/make_payment_from_invoice/"; ?>" + tests_id+"/"+patient_id+"/"+paid_amount,
                    {'nothing': 'nothing'},
                    function (data2) {
                        var data = JSON.parse(data2);
                        console.log(data);
                        if(data == 'ok'){
                            window.location.href = "<?php echo base_url() . 'lab/test-details/view/'; ?>"+tests_id;
                        } else{
                            alert('err');
                        }
...
<script type="text/javascript">
    function report_print() {
        ...
        window.open("<?php echo base_url() . 'lab/test-report-print?test_id='; ?>"+tests_id+"&test_details_id="+test_details_id+"&patient_id="+patient_id, "_blank");
