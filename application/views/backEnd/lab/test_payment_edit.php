            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url() ?>lab/test-payment/list" type="submit" class="btn bg-purple btn-sm" style="color: white;"> <i class="fa fa-list"></i> <?php echo $this->lang->line('test_payment_list'); ?>  </a>
                    </div>
                </div>
                <div class="box-body">
                    <br>
                    <div class="row">
                        <form action="<?php echo base_url("lab/test-payment/edit/".$edit_info->id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="col-md-12">
                                <div class="col-md-3">
...
<script>
    ...
    function loadPatients() {
        ...
        $.post("<?php echo base_url() . "lab/get_patients_data"; ?>",
                {'asd': 'asd'},
                function (data2) {
    ...
    function loadTests(patient_id) {
        ...
        $.post("<?php echo base_url() . "lab/get_tests_data/"; ?>" + patient_id,
                {'nothing': 'nothing'},
                function (data2) {
                    var data = JSON.parse(data2);
