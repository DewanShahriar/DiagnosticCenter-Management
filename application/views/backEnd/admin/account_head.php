            ...
            <div class="box box-warning box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="box-shadow: 1px 1px 15px 5px #c99568; margin: 10px 30px 40px 25px; padding: 30px 0px 30px 0px;">
                        <form action="<?php echo base_url('admin/account-head/edit/'.$edit_info->id) ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="col-md-12">
                                <div class="col-md-3">
                    ...
                    <div class="row" style="box-shadow: 1px 1px 15px 5px #3c8dbc;margin: 10px 30px 40px 25px;padding: 30px 0px 30px 0px;">
                        <form action="<?php echo base_url('admin/account-head/add') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                        ...
                                        <table id="userListTable" class="table table-bordered table-striped table_th_orange">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('admin/account-head/edit/'.$value->id); ?>" class="btn btn-sm bg-green"> <i class="fa fa-edit"></i> </a>
                                                        <?php if($value->readonly == 0){?>
                                                        <a href="<?= base_url('admin/account-head/delete/'.$value->id); ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm bg-orange"> <i class="fa fa-trash"></i> </a>
                                                    <?php }?>
                                                    </td>
                                                </tr>
                                                <?php
