        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="row" style="box-shadow: 0px 0px 10px 0px #3c8dbc; margin: 8px 53px 20px 55px; padding:20px 4px 20px 4px;">
                   <form action="<?php echo base_url('admin/test-payment/list') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="col-md-12">
                            <div class="col-md-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('admin/test-payment/approved/'.$value->id); ?>" class="btn btn-sm bg-green"> <i class="fa fa-check-square-o"></i> </a>
                                        <?php }?>
                                            <a href="<?= base_url('admin/test-payment/edit/'.$value->id); ?>" class="btn btn-sm bg-purple"> <i class="fa fa-edit"></i> </a>
                                            <a href="<?= base_url('admin/test-payment/delete/'.$value->id); ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm bg-orange"> <i class="fa fa-trash"></i> </a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
