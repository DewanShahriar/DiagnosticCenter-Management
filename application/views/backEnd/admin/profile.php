                        ...
                        <form class="form-horizontal" action="<?php echo base_url('admin/profile/update_info') ?>"      method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">
                                    <a  class="btn btn-warning" data-toggle="modal" data-target="#modal-default"><?php echo $this->lang->line('submit'); ?></a>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"><?php echo $this->lang->line('your_current_password'); ?></h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                                    <small style="color: white"> <?php echo $this->lang->line('give_current_password'); ?> </small>
                                                    <input type="password" name="password" class="form-control" placeholder="<?php echo $this->lang->line('current_password'); ?>">
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <center>
                                            <button type="submit" class="btn btn-sm btn-success"><?php echo $this->lang->line('confirm'); ?></button>
                                            </center>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
