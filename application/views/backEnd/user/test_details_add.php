         ...
         <div class="box box-primary box-solid">
            <div class="box-header with-border">
               ...
               <div class="box-tools pull-right">
                  <a href="<?php echo base_url() ?>user/test-details/list" type="submit" class="btn bg-purple btn-sm" style="color: white;"> <i class="fa fa-list"></i> <?php echo $this->lang->line('test_details_list'); ?>  </a>
               </div>
            </div>
...
<script>
    function load_amount(tests_name_id, keyid) {
        $.post("<?php echo base_url() . "user/get_test_amount/"; ?>" + tests_name_id,
            {'nothing': 'nothing'},
            function (data2) {
...
$(document).ready(function() {
    ...
    $("#patient_id").keyup(function() {
       ...
       if (search == "") {
           ...
           $.ajax({
               type: "POST",
               url: "<?php echo base_url() . 'user/patient-search'; ?>",
               data: {search: search },
