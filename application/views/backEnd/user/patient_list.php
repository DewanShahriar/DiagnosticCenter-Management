            ...
            <div class="box box-danger box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url('user/patient/add') ?>" class="btn bg-green btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line("patient_add");?></a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="userListTable" class="table table-bordered table-striped table_th_maroon">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo ++$key; ?></td>
                                <td>
                                    <img src="<?php echo base_url($value->photo);?>" alt="profile " width="60px" height="60px">
                                </td>
                                ...
                                <td> 
                                    <a href="<?php echo base_url('user/patient/edit/'.$value->id); ?>" class="btn btn-sm bg-teal"><i class="fa fa-edit"></i></a>
                                    <a href="<?php echo base_url('user/patient/delete/'.$value->id); ?>" class="btn btn-sm btn-danger" onclick = 'return confirm("Are You Sure?")'><i class="fa fa-trash"></i></a>
                                </td>
