...
<?php
	...
	{
		$this->db->select('tbl_patient.id, tbl_patient.patient_name, tbl_patient.patient_phone, tbl_patient.father_name, tbl_patient.mother_name, tbl_patient.patient_nid, tbl_patient.birth_date, tbl_patient.address, tbl_patient.gender')
			->from('tbl_patient')
