...
class User extends CI_Controller {
        ...
        if ($param1 == 'add') {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($add_test_category) {
                    ...
                    redirect('user/test-category/list', 'refresh');

                } else {

                    $this->session->set_flashdata('message','Test Category Failed!');
                    redirect('user/test-category', 'refresh');
                }
            }

            $data['title']         = 'Test Category Add';
            $data['page']          = 'backEnd/user/test_category_add';
            $data['activeMenu']    = 'test_category_add';
            
        } elseif ($param1 == 'list') {

            $data['title']         = 'Test Category List';
            $data['page']          = 'backEnd/user/test_category_list';
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($this->UserModel->update_test_category($update_test_category_data, $param2)) {
                ...
                redirect('user/test-category/list', 'refresh');
                   ...
                   $this->session->set_flashdata('message','Test Category Update Failed!');
                    redirect('user/test-category/edit/'.$param2, 'refresh');
                }

            }

            $data['title']         = 'Test Category Update';
            $data['page']          = 'backEnd/user/test_category_edit';
            $data['activeMenu']    = 'test_category_edit';
            
        } elseif ($param1 == 'delete' && (int) $param2 > 0) {

            if ($this->UserModel->delete_test_category($param2)) {
        ...
        if ($param1 == 'add') {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($add_test_name) {
                    ...
                    redirect('user/test-name/list', 'refresh');

                } else {

                    $this->session->set_flashdata('message','Test Name Failed!');
                    redirect('user/test-name', 'refresh');
                }
            }
            ...
            $data['page']          = 'backEnd/user/test_name_add';
            $data['activeMenu']    = 'test_name_add';
            
        } elseif ($param1 == 'list') {

            $data['title']         = 'Test Name List';
            $data['page']          = 'backEnd/user/test_name_list';
            $data['activeMenu']    = 'test_name_list';

            $data['test_name_list'] =  $this->UserModel->test_name_list();
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($this->UserModel->update_test_name($update_test_name_data, $param2)) {
                ...
                redirect('user/test-name/list', 'refresh');
                   ...
                   $this->session->set_flashdata('message','Test Name Update Failed!');
                    redirect('user/test-name/edit/'.$param2, 'refresh');
                }
            ...
            $data['page']          = 'backEnd/user/test_name_edit';
            $data['activeMenu']    = 'test_name_edit';
            
        } elseif ($param1 == 'delete' && (int) $param2 > 0) {

            if ($this->UserModel->delete_test_name($param2)) {
        ...
        if ($param1 == 'add') {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($add_patient) {
                    ...
                    redirect('user/patient/list', 'refresh');

                } else {

                    $this->session->set_flashdata('message','Patient Failed!');
                    redirect('user/patient', 'refresh');
                }
            }
            ...
            $data['page']          = 'backEnd/user/patient_add';
            $data['activeMenu']    = 'patient_add';
            
        } elseif ($param1 == 'list') {

            $data['title']         = 'Patient List';
            $data['page']          = 'backEnd/user/patient_list';
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($this->UserModel->update_patient($patient_update_data, $param2)) {
                ...
                redirect('user/patient/list', 'refresh');
                   ...
                   $this->session->set_flashdata('message','Patient Update Failed!');
                    redirect('user/patient/edit/'.$param2, 'refresh');
                }
            ...
            $data['page']          = 'backEnd/user/patient_edit';
            $data['activeMenu']    = 'test_name_edit';
            
        } elseif ($param1 == 'delete' && (int) $param2 > 0) {

            if ($this->UserModel->delete_patient($param2)) {
        ...
        if ($param1 == 'add') {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (true) {
                    ...
                    redirect('user/test-details/list', 'refresh');

                } else {

                    $this->session->set_flashdata('message','Test Details target Failed!');
                    redirect('user/test-details', 'refresh');
                }
            ...
            $data['page']          = 'backEnd/user/test_details_add';
            ...
            $data['test_list']     =  $this->UserModel->test_list($data['search']);
            // echo "<pre>";
            ...
            $data['page']          = 'backEnd/user/test_list';
            $data['activeMenu']    = 'test_details_list';

        } elseif ($param1 == 'view' && (int) $param2 > 0) {

            $data['test']          = $this->UserModel->get_test_data($param2);

            $data['test_details']  = $this->UserModel->get_test_details_data($param2);
            $data['paid_amount']   = $this->UserModel->get_paid_amount($param2);
            // echo "<pre>";
            // print_r($data['paid_amount']);
            // exit;

            $data['title']         = 'Test details List';
            $data['page']          = 'backEnd/user/test_view';
            $data['activeMenu']    = 'test_details_list';

        } elseif ($param1 == 'delete' && (int) $param2 > 0) {

            if ($this->UserModel->delete_tests($param2)) {
    ...
    public function tests_list_print()
    {
        ...
        $data['tests_list']     =  $this->UserModel->tests_list($data);
    ...
    public function patient_search()
    {
        ...
        $result      = $this->UserModel->patient_data_search($search_data);
        echo json_encode($result, JSON_UNESCAPED_UNICODE);
    }
    ...
    public function report_format_update()
    {
        ...
        if(true){
            ...
            redirect('user/test-details/view/'.$test_id, 'refresh');
        } else{
        ...
        if ($param1 == 'add') {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($add_test_payment) {
                    ...
                    redirect('user/test-payment/list', 'refresh');

                } else {

                    $this->session->set_flashdata('message','Test payment Failed!');
                    redirect('user/test-payment', 'refresh');
                }
            }

 
            $data['title']         = 'Test payment Add';
            $data['page']          = 'backEnd/user/test_payment_add';
            ...
            $data['test_payment_list'] =  $this->UserModel->test_payment_list($data['search']);
            ...
            $data['page']          = 'backEnd/user/test_payment_list';
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $data['due_report_list'] = $this->UserModel->get_due_report($data['search']);
            ...
            $data['page']          = 'backEnd/user/due_report';
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($this->UserModel->update_test_payment($update_test_payment_data, $param2)) {
                ...
                redirect('user/test-payment/list', 'refresh');
                   ...
                   $this->session->set_flashdata('message','Test payment Update Failed!');
                    redirect('user/test-payment/edit/'.$param2, 'refresh');
                }

            }

            $data['title']         = 'Test payment Update';
            $data['page']          = 'backEnd/user/test_payment_edit';
            $data['activeMenu']    = 'test_payment_edit';
            
        } elseif ($param1 == 'delete' && (int) $param2 > 0) {

            if ($this->UserModel->delete_test_payment($param2)) {
            ...
            if ($this->UserModel->approved_test_payment($param2)) {
